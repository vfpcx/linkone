...
- [完成] **T1-BE 正向申请链后端（2026-07-30 合并 main=4d93c5c）**：V19/九端点/5% 双侧边界/R3 纠错封顶/INBOUND_SUBMIT/WK SKU 端点补口；270/270 独立复验绿（+20）；偏差 10 条回写 13 v1.1
- [完成·半] **T3-W1 退货链后端（2026-07-31 合并 main=321ef14）**：V20/RTN- 登记时扣/pallet_delta 落列+五类双写/batch_enabled 禁改；285/285 独立复验绿（+15）；偏差 11 条回写 13 v1.2
- [进行中] **T1-FE 正向申请链前端**〔feat/p3b-inbound-fe〕：申请表单/受理工作台/纠错弹窗，收尾 E2E 中
- [进行中·T3-W2] **T3-W2 → T3-FE ∥ T4-W1**：盘点 PD-+盘亏封顶+托盘释放补齐 → T3 前端 ∥ T4 后端一（batches 表+FIFO 推算+batch_enabled 禁改）
